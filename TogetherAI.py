...
def Together_AI():
    ...
    prompt_file_path = "variable text files/prompt.txt"  # Replace with your file path
    input_file_path = "variable text files/input.txt"
    ...
    save_response_to_txt('variable text files/output.txt', response.choices[0].message.content)
